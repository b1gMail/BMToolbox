...
void MacHelper::launchUpdater(const char *path)
{
    NSString *bundlePath = [[NSBundle mainBundle] bundlePath],
            *updaterPath = [NSString stringWithCString:path length:strlen(path)];
    [NSTask launchedTaskWithLaunchPath:updaterPath arguments:[NSArray arrayWithObjects:bundlePath, [NSString stringWithFormat:@"%d", [[NSProcessInfo processInfo] processIdentifier]], nil]];
}
